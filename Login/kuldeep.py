...
logo = PhotoImage(file="yadav.png")

w1 = Label(root, image=logo,height=170).pack()

Label(root,text="\n")
Label(root, text=names[8],height='2',width='30',font=('Times',18,'bold'),bg='light cyan').pack()


from InfoAppend import *
for i in range(0,14):
  Label(root,text=text_var[8][i],font=('Times',10),width='40',height='2',bg='light cyan').pack()
