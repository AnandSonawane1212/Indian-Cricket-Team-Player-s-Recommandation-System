...
def warning_one():
  ...
  Label(screen10, text = "\n\nPlaese Pre-Process Data and Process data\n\n ",font=("TkHeadingFont",17), fg='black',bg = "light cyan").pack()
...
def display_squad():
  ...
  option_list=['Batsmen','Bowlers','All Rounders As Batsmen','All Rounders As Bowler']
  global var1
...
def ok():
  ...
  elif (visualization_choice=='All Rounders As Batsmen'):
    os.system("python3 a.py")
  elif (visualization_choice=='All Rounders As Bowler'):
...
def main_screen():
  ...
  screen.title("Alumni Management System")
